...
def get_retriever():
    ...
    # 기존에 있는 데이터를 뽑아오는 작업
    vectorstore=PineconeVectorStore.from_existing_index(        # from_existing_index는 불러오기만 하는 함수
